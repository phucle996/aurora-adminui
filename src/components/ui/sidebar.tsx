    ...
    >
      ...
      >
        <div
          ...
          className='flex h-full w-full flex-col border border-sidebar-border/80 bg-sidebar shadow-[var(--shadow-card)] group-data-[variant=floating]:rounded-2xl group-data-[variant=floating]:shadow-[var(--shadow-overlay)] group-data-[variant=inset]:rounded-2xl'
        >
          {children}
        </div>
      </div>
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        'flex h-8 shrink-0 items-center rounded-md px-2.5 text-[11px] font-semibold tracking-[0.12em] text-sidebar-foreground/55 uppercase ring-sidebar-ring outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
...
const sidebarMenuButtonVariants = cva(
  'peer/menu-button flex w-full items-center gap-3 overflow-hidden rounded-xl px-3 py-2 text-start text-sm font-medium text-sidebar-foreground outline-hidden ring-sidebar-ring transition-[width,height,padding,background-color,color] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pe-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-semibold data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:size-10! group-data-[collapsible=icon]:p-2.5! [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0',
  {
    variants: {
      variant: {
        default: 'hover:bg-sidebar-accent hover:text-sidebar-accent-foreground',
        outline:
          'border border-sidebar-border bg-background shadow-[var(--shadow-card)] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground',
      },
      size: {
...
function SidebarMenuBadge({
  ...
  return (
    <div
      ...
      className={cn(
        'pointer-events-none absolute end-2 flex h-5 min-w-5 items-center justify-center rounded-full bg-sidebar-accent px-1.5 text-[11px] font-semibold text-sidebar-accent-foreground tabular-nums select-none',
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<'ul'>) {
  return (
    <ul
      ...
      className={cn(
        'mx-4 flex min-w-0 translate-x-px flex-col gap-1.5 border-s border-sidebar-border px-3 py-1',
        'group-data-[collapsible=icon]:hidden',
        className
      )}
      {...props}
...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        'flex h-8 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-lg px-2.5 text-sidebar-foreground ring-sidebar-ring outline-hidden hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-inherit',
